...
public class RecursiveActivity extends ActionBarActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        listView = (ListView) findViewById(R.id.recursive_list);
    ...
    public boolean onContextItemSelected(MenuItem item)
    {
        ...
        if(id==R.id.Edit)
        {
            ...
            c.close();
            Intent i=new Intent(RecursiveActivity.this,AddRecursiveActivity.class);
        ...
        if(id==R.id.Delete)
        {
            ...
            {
                Intent i = new Intent(RecursiveActivity.this, RecursiveActivity.class);
                startActivity(i);
                Toast.makeText(RecursiveActivity.this, "Recursive Transaction Deleted", Toast.LENGTH_LONG).show();
            }
        }
