...
/**
 * Created by Gaurav on 4/28/15.
 */
public class ReportsSubCategoriesAdapter extends ArrayAdapter<SubCategoryDB>
{
    Context context1;
    int layout;
    String curCode;
    ArrayList<CurrencyDB> al1;
    ArrayList<SubCategoryDB> al;
    int period;

    public ReportsSubCategoriesAdapter(Context context, int resource,ArrayList<SubCategoryDB> objects,int i)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        SubCategoryDB db=al.get(position);
        name.setText(db.sub_name);
