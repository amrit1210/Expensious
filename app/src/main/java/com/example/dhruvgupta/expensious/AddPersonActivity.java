...
public class AddPersonActivity  extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        personDBHelper=new PersonDBHelper(AddPersonActivity.this);
    ...
    public void onSavePerson(View v)
    {
        ...
        if(mPerson.length()>0 )
        {
           ...
           personDBHelper.addPerson(mPerson.getText().toString(),mImgColor.getBackground().toString());
           personDBHelper.getAllPerson();
